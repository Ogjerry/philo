...
import { Edge, Node, ClusterNode, Layout, NgxGraphZoomOptions } from '@swimlane/ngx-graph';
import { Subject, of, Observable, map } from 'rxjs';
import { nodes, clusters, links } from './data';

const zoomToFitSubject: Subject<boolean> = new Subject<boolean>();
